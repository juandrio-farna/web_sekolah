                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body my-auto px-5">
                            ...
                            <label for="jurusanSelect">Pilih Jurusan/Mata Pelajaran:</label>
                            <select id="jurusanSelect" class="custom-select mb-3">
                                <option value="">-- Pilih Jurusan/Mata Pelajaran --</option>
                                ...
                                <option value="IPA/B.LAMPUNG">IPA/B. Lampung</option>
                                <option value="Al Qur'an/Hadis">Al Qur'an/Hadis</option>
                                <option value="Agama Islam">Agama Islam</option>
                                <option value="Seni Budaya">Seni Budaya</option>
                                <option value="BK/PAK/TIK">BK/PAK/TIK</option>
                            </select>
                ...
                <div class="col-lg-3 col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="pl-3">
                                <li>Jika berhasil scan, maka akan muncul data siswa/guru di bawah preview kamera</li>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#absenBtn', function() {
        const jurusan = $('#jurusanSelect').val();
        if (!jurusan) {
            alert('Silakan pilih jurusan/mata pelajaran.');
            return;
        }

        // Panggil fungsi untuk melakukan absensi
        // Kode absensi berdasarkan jurusan dan waktu (masuk/pulang)
        // Anda bisa menambahkan AJAX untuk mengirim data ke server.
    });
